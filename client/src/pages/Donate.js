    ...
    return (
        <>
            <div className="grid grid-cols-6 gap-4 mt-5">
                ...
                <div data-aos="fade-left" className="donate-intro-text" style={{ display: 'inline-block' }}>
            ...
            <div className="grid grid-cols-6 gap-4 mt-5">
                ...
                <div data-aos="fade-left" className="col-start-2 col-end-6">
                ...
                <div data-aos="fade-left" className="donate-points">
                    <div>
                ...
                <div data-aos="fade-left" className="donate-button">
            ...
            <div className="grid grid-cols-6 gap-4 mt-5">
                ...
                <div data-aos="fade-right" className="col-start-2 col-end-6">
                ...
                <div data-aos="fade-right" className="donate-points">
                ...
                <div data-aos="fade-right" className="donate-button">
            ...
            {/* Climate Ride */}
            <div className="grid grid-cols-6 gap-4 mt-5 mb-10">
                ...
                <div data-aos="fade-right" className="donate-button mb-5">
