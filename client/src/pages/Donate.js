    ...
    return (
        <>
            <div className="grid grid-cols-6 gap-4 mt-5">
                ...
                <div className="col-start-2 col-end-5 mb-3">
                    <div>
            ...
            <div className="grid grid-cols-6 gap-4 mt-5">
                ...
                <div className="col-start-5 col-end-7 ">
                    ...
                    <div className="text-xl text-slate-600 pb-3 pr-2">
                    ...
                    <div className="col-start-5 col-end-7 mt-3">
            ...
            <div className="grid grid-cols-6 gap-4 mt-5">
                <div className="col-start-2 col-end-7 mt-5">
                    ...
                    <div className="mt-3 text-5xl font-bold text-slate-700 leading-snug">Clean Air Task Force</div>
                </div>
                <div className="col-start-2 col-end-6 text-xl text-slate-600">
            ...
            <div className="grid grid-cols-6 gap-4 mt-5">
                <div>
                    ...
                    <div>
                        ...
                        <span><FilterVintageRoundedIcon /><div className="pl-2 text-xl text-slate-600">Protects biodiversity</div></span>

                        <span><FilterVintageRoundedIcon /><div className="pl-2 text-xl text-slate-600">Promotes Indigenous land rights</div></span>

                        <span><FilterVintageRoundedIcon /><div className="pl-2 text-xl text-slate-600">Prevents deforestation</div></span>
